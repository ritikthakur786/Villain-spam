...
HELP_STRING = f"★ 𝗩𝗜𝗟𝗟𝗔𝗜𝗡 𝗛𝗘𝗟𝗣 𝗠𝗘𝗡𝗨 ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @iamakki001**"
...
HELP_BUTTON = [
    ...
    [
      Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/iamvillain77"),
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/oldskoolgc")
    ]
  ]
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://files.catbox.moe/pcncfx.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own Altron Bots !! @iamakki001", cache_time=0, alert=True)
